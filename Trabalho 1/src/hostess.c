...
void* hostess_run() {
    ...
    */
    ...
    while (globals_get_store_open()) {  // Adicione a lógica para que o Hostess realize o fechamento do Sushi Shop!
        if (queue->_length > 0) {
    ...
    //Aqui desaloca todos os clientes que estiverem na fila.
