...
// Globais Criadas
int global_store_open;          // Implementada, Funcionando
int* global_produced_food;      // Implementada, Funcionando
int* global_consumed_food;      // Implementada, Funcionando
int global_satisfied_customers; // Implementada, Não Testada
...
void globals_set_store_open(int store_open) {
    global_store_open = store_open;
}

int globals_get_store_open() {
    return global_store_open;
}

// CONTADOR DE PRATOS PRODUZIDOS ("Ponteiro para vetor")
void globals_set_produced_food(int* produced_count) {
    global_produced_food = produced_count;
}

int* globals_get_produced_food() {
    return global_produced_food;
}

// CONTADOR DE PRATOS CONSUMIDOS ("Ponteiro para vetor")
void globals_set_consumed_food(int* consumed_count) {
    global_consumed_food = consumed_count;
}

int* globals_get_consumed_food() {
    return global_consumed_food;
}

// CONTADOR DE CLIENTES SATISFEITOS
void globals_set_satisfied_customers(int satisfied_count) {
    global_satisfied_customers = satisfied_count;
}

int globals_get_satisfied_customers() {
    return global_satisfied_customers;
}
